...
export const POKEMON_DATA = [
  { id: 'ditto', name: '메타몽', types: ['normal'], starter: true, conditions: [] },
  { id: 'rattata', name: '꼬렛', types: ['normal'], conditions: [
    { type: 'energy_min', energy: 'normal', value: 1 },
  ]},
  { id: 'charmander', name: '파이리', types: ['fire'], conditions: [
    { type: 'energy_min', energy: 'normal', value: 100 },
  ], effects: [
    { type: 'ditto_add_type', energy: 'fire', value: 1, label: '[메타몽 변신 - 파이리] 메타몽이 불꽃에너지를 추가 생산한다.' },
  ]},
  { id: 'squirtle', name: '꼬부기', types: ['water'], conditions: [
    { type: 'energy_min', energy: 'normal', value: 100 },
  ]},
  { id: 'piplup', name: '팽도리', types: ['water'], conditions: [
    { type: 'energy_min', energy: 'water', value: 10 },
  ]},
  { id: 'charmeleon', name: '리자드', types: ['fire'], conditions: [
  ...
  { id: 'monferno', name: '파이숭이', types: ['fire', 'fighting'], conditions: [
    { type: 'energy_min', energy: 'fire', value: 100 },
  ]},
  { id: 'prinplup', name: '팽태자', types: ['water'], conditions: [
    { type: 'energy_min', energy: 'water', value: 100 },
  ]},
  { id: 'charizard', name: '리자몽', types: ['fire', 'flying'], conditions: [
  ...
  { id: 'infernape', name: '초염몽', types: ['fire', 'fighting'], conditions: [
    { type: 'energy_min', energy: 'fire', value: 1000 },
  ]},
  { id: 'empoleon', name: '엠페르트', types: ['water', 'steel'], conditions: [
    { type: 'energy_min', energy: 'water', value: 1000 },
  ]},
  { id: 'spiritomb', name: '화강돌', types: ['ghost', 'dark'], conditions: [
